var app = (function () {
	...
	function create_main_fragment(component, ctx) {
		...
		return {
			c: function create() {
				...
				if (!slot_content_heading) {
					addLoc(div0, file, 10, 10, 274);
				}
				div1.className = "card-heading svelte-jn0nca";
				addLoc(div1, file, 8, 6, 205);
				if (!slot_content_body) {
					addLoc(div2, file, 14, 8, 359);
				}
				if (!slot_content_footer) {
					a.href = "/previous-step";
					addLoc(a, file, 18, 10, 464);
					button.type = "submit";
					button.className = "bs-btn";
					addLoc(button, file, 19, 10, 513);
				}
				div3.className = "card-footer svelte-jn0nca";
				addLoc(div3, file, 16, 6, 397);
				div4.className = "card-section svelte-jn0nca";
				addLoc(div4, file, 7, 4, 171);
				...
				addLoc(path1, file, 31, 10, 1298);
				setAttribute(g, "class", "svelte-jn0nca");
				addLoc(g, file, 27, 8, 897);
				...
				setAttribute(svg, "class", "svelte-jn0nca");
				addLoc(svg, file, 26, 6, 695);
				div5.className = "loading-section svelte-jn0nca";
				toggleClass(div5, "visible", ctx.step.isLoading);
				addLoc(div5, file, 23, 4, 612);
				addListener(form, "submit", submit_handler);
				form.className = "bs-card white svelte-jn0nca";
				addLoc(form, file, 4, 2, 93);
				div6.className = "scroll-section svelte-jn0nca";
	...
	function create_main_fragment$2(component, ctx) {
		...
		const get_key = ctx => ctx.answerID;
		...
		return {
			...
			p: function update(changed, ctx) {
				const each_value = ctx.question.answerElements;
	...
	function create_main_fragment$9(component, ctx) {
		...
		return {
			c: function create() {
				...
				text = createText("\r\n\r\n");
				div = createElement("div");
				div.className = "footer-displacer svelte-1c13lze";
	...
	function create_if_block(component, ctx) {
		...
		const get_key = ctx => ctx.section.id;
		...
		return {
			...
			p: function update(changed, ctx) {
				const each_value = ctx.$interview.sections;
